...
# C compiler flags
# 指定编译所带的参数。
# 这里指定编译的目标平台是arm64，bitcode选项，编译的库最低支持的iOS版本
CFLAGS="-arch arm64 -fembed-bitcode -miphones-version-min=7.0" \
...
LDFLAGS="-arch arm64 -fembed-bitcode -miphones-version-min=7.0"
